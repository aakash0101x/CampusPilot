...
function StudentLoginComponent() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const loginData = { s_id: id, password };
        try {
            const response = await fetch("https://campuspilot.onrender.com/login/student", {
                method: 'POST',
                headers: {
    ...
    return (
        <div className="flex justify-center bg-gray-100">
            <div className="w-full max-w-md m-10 p-8 space-y-6 bg-white shadow-lg rounded-lg">
                <h2 className="text-3xl font-bold text-center text-blue-600">Login as Student</h2>
